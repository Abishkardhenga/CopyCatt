...
interface AuroraBackgroundProps {
  ...
  speed?: number
  opacity?: number
  /** Pixel ratio cap to reduce GPU cost on retina */
...
export function AuroraBackground({
  className,
  colorStops = ["#39FF14", "#7CFF67", "#39FF14"],
  amplitude = 0.85,
  blend = 0.48,
  speed = 0.9,
  opacity = 0.55,
  ...
  useEffect(() => {
    ...
    function update(t: number) {
      ...
      program.uniforms.uColorStops.value = stopsArray
  ...
  }, [amplitude, blend, speed, stopsArray, prefersReducedMotion, maxDevicePixelRatio, isSmallScreen])
  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "absolute inset-0",
          isSmallScreen && "bg-[radial-gradient(900px_520px_at_50%_35%,rgba(57,255,20,0.12),transparent_60%)]"
        )}
      />
      <div className="absolute inset-0 bg-[radial-gradient(1200px_700px_at_50%_35%,rgba(57,255,20,0.10),transparent_55%)]" />
    </div>
  )
}
